...
def main():
    ...
    try:
        ...
        encoder_path = "models/{}/{}".format(
            args.model_name, list(filter(lambda x: ".encoder" in x, files))[0]
        )
        decoder_path = "models/{}/{}".format(
            args.model_name, list(filter(lambda x: ".decoder" in x, files))[0]
        )
    ...
    evaluate_randomly(
        test_pairs, encoder, decoder, input_lang, output_lang, n=args.num_tests
    )
